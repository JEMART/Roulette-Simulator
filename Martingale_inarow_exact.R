...
#the Martingale system while tracking the money meanwhile

# Add betting to the spins
#Martingale: To every spin, bet (start 1 unit) on a colour. Double the bet until you win, then bet 1 unit on the other colour. 
...
Lets.play.Martingale<-function(b,c,x){  #b= amount of min money bet (unit)   c=colour bet on in the first spin, x=total number of spins
